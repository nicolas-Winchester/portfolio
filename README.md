...
Para esta practica utilize css basico para crear cajas, estilos y colores, y las organice mediante el uso de grid tambien le añadí un hover para dar foco a los elementos
